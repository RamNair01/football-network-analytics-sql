...
SELECT 'clubelo_ratings', COUNT(*)
FROM raw.clubelo_ratings

UNION ALL

SELECT 'non_league_fixtures', COUNT(*)
FROM raw.non_league_fixtures

UNION ALL

SELECT 'team_name_mapping', COUNT(*)
